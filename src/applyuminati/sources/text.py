...
TECH_VOCABULARY: frozenset[str] = frozenset(
    {
        ...
        "php", "swift", "kotlin", "scala", "c", "c++", "c#", "objective-c", "elixir",
        "clojure", "haskell", "perl", "r", "julia", "dart", "lua", "shell", "bash",
        "sql", "postgresql", "mysql", "sqlite", "mongodb", "redis", "dynamodb",
        "cassandra", "elasticsearch", "snowflake", "bigquery", "redshift", "clickhouse",
        "kafka", "rabbitmq", "sqs", "kinesis", "nats",
        "react", "react native", "vue", "angular", "svelte", "next.js", "nuxt",
        "node.js", "express", "django", "flask", "fastapi", "spring", "spring boot",
        "rails", "laravel", "asp.net", ".net", "gin", "echo", "actix", "axum",
        "graphql", "grpc", "rest", "openapi", "protobuf",
        "aws", "gcp", "azure", "docker", "kubernetes", "k8s", "terraform",
        "ansible", "puppet", "chef", "helm", "pulumi", "cloudformation",
        "linux", "unix", "windows", "macos",
        "git", "github", "gitlab", "bitbucket", "jenkins", "circleci", "github actions",
        "pytest", "jest", "vitest", "cypress", "playwright", "selenium", "junit",
        "pandas", "numpy", "scipy", "scikit-learn", "tensorflow", "pytorch",
        "keras", "xgboost", "spark", "hadoop", "airflow", "dbt", "prefect", "dagster",
        "tableau", "looker", "power bi", "superset",
        "html", "css", "tailwind", "sass", "scss", "less",
        "webpack", "vite", "rollup", "esbuild", "babel",
        "redis", "memcached", "celery", "sidekiq", "resque",
        "oauth", "oidc", "saml", "jwt", "sso",
        "microservices", "event-driven", "ddd", "tdd", "ddd",
        "agile", "scrum", "kanban",
        "kotlin", "gradle", "maven", "sbt",
        "nginx", "apache", "haproxy", "envoy", "traefik",
        "prometheus", "grafana", "datadog", "sentry", "opentelemetry",
        "fpga", "verilog", "vhdl",
        "embedded", "rtos", "arduino", "raspberry pi",
    }
)
...
def _skill_pattern(token: str) -> re.Pattern[str]:
    ...
    if pattern is None:
        # Allow dots and + inside the token (node.js, c++); word boundaries
        # otherwise. Escape regex metacharacters.
